...
for(i in 1:length(slug)){
  print(i)
  rb <- brick(paste0("/Volumes/My Passport for Mac/NCARNARR/All/", BigDays.sfdfT$slug2[i], "/",BigDays.sfdfT$slug[i]))
...
aCAPE <- c(aCAPE, as.numeric(raster::extract(cape, BigDay421, fun = mean, method = 'bilinear')))
