...
model3 <- lmer(casualties ~ I(maxPopDens/100) + (1|Month) + maxBS2 + minCIN2 + maxHLCY2,
             weights = nT, 
             data = BigDays.sfdfT)
summary(model3)

model4 <- lmer(casualties ~ I(maxPopDens/100) + (1|Month) + maxBS2 + maxCAPE2 + maxHLCY2 + minCIN2,
             weights = nT, 
             data = BigDays.sfdfT)
summary(model4)


model5 <- lmer(log(GroupTotalED) ~ I(Year - 2004) + (1|Month) + 
                  maxBS2 + maxCAPE2 + maxHLCY2,
             weights = nT, 
             data = BigDays.sfdfT)
summary(model5)
