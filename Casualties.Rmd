...
```{r, eval = FALSE}
save(BigDays.sfdfT, file = "BigDays2.RData")
load("BigDays2.RData")
dim(BigDays.sfdfT)
```
...
```{r, eval = FALSE}
save(Torn.sfT, file = "BigDayTornadoes2.RData")
load("BigDayTornadoes2.RData")
dim(Torn.sfT)
```
...
for(i in 1:length(slug)){
  print(i)
  rb <- brick(paste0("/Volumes/Zoe's Drive/NCARNARR/All/", BigDays.sfdfT$slug2[i], "/",BigDays.sfdfT$slug[i])) #<-- this is for varying NARR times
...
```{r, eval = FALSE}
#1995 Data: 
  rb <- raster("/Volumes/My Passport for Mac/PhD_Program/Projects/Pred-casualties/PopDens/usadens/usads95g/w001001.adf")
...
#2000 Data: 
  rb <- raster(paste0("/Volumes/My Passport for Mac/PhD_Program/Projects/Pred-casualties/PopDens", "/gpw-v4-population-density-rev10_2000_2pt5_min_tif/gpw_v4_population_density_rev10_2000_2pt5_min.tif"))
  ext = raster::extent(c(-125, -67, 24, 50))
  PopDens = crop(rb, ext)
...
#2005 Data: 
    rb <- raster(paste0("/Volumes/My Passport for Mac/PhD_Program/Projects/Pred-casualties/PopDens", "/gpw-v4-population-density-rev10_2005_2pt5_min_tif/gpw_v4_population_density_rev10_2005_2pt5_min.tif"))
  ext = raster::extent(c(-125, -67, 24, 50))
  PopDens = crop(rb, ext)
...
#2010 Data: 
    rb <- raster(paste0("/Volumes/My Passport for Mac/PhD_Program/Projects/Pred-casualties/PopDens", "/gpw-v4-population-density-rev10_2010_2pt5_min_tif/gpw_v4_population_density_rev10_2010_2pt5_min.tif"))
  ext = raster::extent(c(-125, -67, 24, 50))
  PopDens = crop(rb, ext)
...
#2015 Data: 
    rb <- raster(paste0("/Volumes/My Passport for Mac/PhD_Program/Projects/Pred-casualties/PopDens", "/gpw-v4-population-density-rev10_2015_2pt5_min_tif/gpw_v4_population_density_rev10_2015_2pt5_min.tif"))
  ext = raster::extent(c(-125, -67, 24, 50))
  PopDens = crop(rb, ext)
...
```{r}
x <- BigDays.sfdfT[-c(8,22, 25:29, 46:59)]
BigDays <- x

y <- Torn.sfT[-c(19:20,22,25:26,32)]
BigDayTornadoes <- y

save(BigDays, BigDayTornadoes, file = "outbreakdays.RData")
```
