---
title: "Relatonship between casualties and environmental factors on the most prolific tornado days"
...
Create an ID for unique big days. It needs to have the group number and the cDate
```{r}
Tor.sfdfT <- Tor.sfdfT %>%
...
```{r, eval = FALSE}
groups <- BigDays.sfdfT$groupNumber
Tor.sfdfT <- Tor.sfdfT %>%
  filter(groupNumber %in% groups) 
```
